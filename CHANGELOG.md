...
## [0.1.0.4] 2026-01-16
 - Fixed cell population issue. It was caused by list replacement while padding the sublists; so the background workers weren't able to populate the cells as their reference lists had actually been replaced. 
